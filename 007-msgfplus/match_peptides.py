...
result_out_path = '{0}msgfp_v1\\'.format(output_path)
...
result_file = '{0}matched_pepdtide_results.txt'.format(result_out_path)
...
msgfplus_peptide_filtered_file = '{}KO_Rpick_Merged_qfilter_0.0001.txt'.format(result_out_path)
