...
open(IN, "KO_Rpick_Merged_I.tsv") or die "can't open file"; 
my %new=(); 
my $e=0; 
my $t=20; 
my $line=<IN>;
...
my %old=(); 
open(IN, "Ralstonia_pickettii.blib.peptides.txt") or die "can't open file"; 
while (my $line=<IN>)
{
	chomp($line);
	$line=~s/L/I/g; 
...
open (OUT, ">KO_Rpick_Merged_I_qfilter_0.0001.txt") or die "can't open file"; 
